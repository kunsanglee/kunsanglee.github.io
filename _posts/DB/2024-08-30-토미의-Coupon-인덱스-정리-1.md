...
![[Pasted image 20240829195911.png]]
...
![[Pasted image 20240829200549.png]]
...
```
![[Pasted image 20240829204204.png]]
![[Pasted image 20240829204245.png]]
...
![[Pasted image 20240830010640.png]]
```markdown
| # | Table        | Non_unique | Key_name                        | Seq_in_index | Column_name | Collation | Cardinality | Sub_part | Packed | Null | Index_type | Comment | Index_comment | Visible |
|---|--------------|------------|---------------------------------|---------------|-------------|-----------|-------------|----------|--------|------|-------------|---------|----------------|---------|
| 1 | member_coupon| 0          | PRIMARY                         | 1             | id          | A         | 468036      |          |        |      | BTREE       |         |                | YES     |
...
![[Pasted image 20240830011011.png]]
```markdown
| # | id | select_type | table | partitions | type | possible_keys                     | key                             | key_len | ref   | rows | filtered | Extra       |
|---|----|--------------|-------|------------|------|-----------------------------------|---------------------------------|---------|-------|------|----------|-------------|
...
```
![[Pasted image 20240830014647.png]]
...
show index from member_coupon;
```
![[Pasted image 20240830021433.png]]
